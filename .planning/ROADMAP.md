...
- [ ] **Phase 5: Shared singleflight helper** - Shared `singleflightGetOrSet` helper in the cache package: setter-only wrap, DoChan cancel variant, panic recovery, Get double-check
...
| 5. Shared singleflight helper | v1.6 | TBD | Not started | - |
